...
import clavicom.gui.keyboard.key._UIKeyClavicom;
...
public class _UIKeyList
{
	...
	//------------------------------------------------------ CONSTRUCTEURS --//		
	public _UIKeyList(CKeyList coreKeyList)
	{
		...
		{		
			...
			{
				// Construction d'une UIKey du bon type
				_UIKeyClavicom uiKey = new _UIKeyClavicom((CKeyClavicom)currentCoreKey);
