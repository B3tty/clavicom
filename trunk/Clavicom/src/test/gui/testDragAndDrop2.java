...
public class testDragAndDrop2 extends JFrame implements ActionListener, DropTargetListener {
  DragLabel source = new DragLabel("Drag and drop me to the following JButton", JLabel.CENTER);

  JButton target = new JButton();

  testDragAndDrop2(String title) {
    super(title);
  ...
  public static void main(String[] args) {
    new testDragAndDrop2("Drag and Drop Demo");
  }
}
