...
public abstract class CKeyKeyboard extends CKey
{
	...
	public CKeyKeyboard(Element eltKey) throws Exception
	{
		...
		if ( eltKey == null )
		{
			throw new Exception(UIString
					.getUIString("EX_KEYBOARDKEY_EMPTY_NODE"));
		...
		if ( eltCoord == null )
		{
			throw new Exception(
					UIString
							.getUIString("EX_KEYBOARDKEY_MISSING_ATTRIBUTE_COORDINATE_1")
							+ TXMLNames.KY_ELEMENT_COORDINATES
							+ UIString
									.getUIString("EX_KEYBOARDKEY_MISSING_ATTRIBUTE_COORDINATE_2"));
		}
		...
		{
			throw new Exception(UIString
					.getUIString("EX_KEYBOARDKEY_BAD_NUMBER_OF_POINT")
		...
		for ( Object objCourant : elements )
		{
			...
			else
			{
				throw new Exception(
						UIString
								.getUIString("EX_KEYBOARDKEY_UNVALID_COORDINATE_POS_1")
								+ TXMLNames.KY_ATTRIBUTE_COORDINATE_POS
								+ UIString
										.getUIString("EX_KEYBOARDKEY_UNVALID_COORDINATE_POS_2"));
			}

			if ( eltCourant.getAttributeValue(
					TXMLNames.KY_ATTRIBUTE_COORDINATE_POS).equals(
					TXMLNames.KY_ATTRIBUTE_COORDINATE_POS_MAX) )
			{
				if ( maxFound == false )
				{
					...
					{
						throw new Exception(UIString
								.getUIString("EX_KEYBOARDKEY_BAD_MAX_POINT")
								+ e.getMessage());
					}
				}
				else
				{
					throw new Exception(
							UIString
									.getUIString("EX_KEYBOARDKEY_SURNUMEROUS_MAX_POINT_1")
									+ TXMLNames.KY_ATTRIBUTE_COORDINATE_POS
									+ UIString
											.getUIString("EX_KEYBOARDKEY_SURNUMEROUS_MAX_POINT_2")
									+ TXMLNames.KY_ATTRIBUTE_COORDINATE_POS_MAX
									+ UIString
											.getUIString("EX_KEYBOARDKEY_SURNUMEROUS_MAX_POINT_3"));
				}

			}
			else if ( eltCourant.getAttributeValue(
					TXMLNames.KY_ATTRIBUTE_COORDINATE_POS).equals(
					TXMLNames.KY_ATTRIBUTE_COORDINATE_POS_MIN) )
			{
				if ( minFound == false )
				{
					...
					{
						throw new Exception(UIString
								.getUIString("EX_KEYBOARDKEY_BAD_MIN_POINT")
								+ e.getMessage());
					}
				}
				else
				{
					throw new Exception(
							UIString
									.getUIString("EX_KEYBOARDKEY_SURNUMEROUS_MIN_POINT_1")
									+ TXMLNames.KY_ATTRIBUTE_COORDINATE_POS
									+ UIString
											.getUIString("EX_KEYBOARDKEY_SURNUMEROUS_MIN_POINT_2")
									+ TXMLNames.KY_ATTRIBUTE_COORDINATE_POS_MIN
									+ UIString
											.getUIString("EX_KEYBOARDKEY_SURNUMEROUS_MIN_POINT_3"));
				}
			}
		}
	...
	public abstract void completeNodeSpecific(Element eltKeyNode)
			throws Exception;
	...
	private void completeNodeGlobal(Element myNode, int order)
	{
		// Ordre
		myNode
				.setAttribute(TXMLNames.KY_ATTRIBUTE_ORDER, String
						.valueOf(order));
		...
		Attribute attPointMin = new Attribute(
				TXMLNames.KY_ATTRIBUTE_COORDINATE_POS,
				TXMLNames.KY_ATTRIBUTE_COORDINATE_POS_MIN);
		...
		Attribute attPointMax = new Attribute(
				TXMLNames.KY_ATTRIBUTE_COORDINATE_POS,
				TXMLNames.KY_ATTRIBUTE_COORDINATE_POS_MAX);
